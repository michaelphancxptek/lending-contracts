...
export const VchainConfig: IVchainConfiguration = {
  ...CommonsConfig,
  MarketId: "Vchain market",
  ProviderId: 4,
  ReservesConfig: {
    // WETH: strategyWETH,
    // DAI: strategyDAI,
  ...
  ReserveAssets: {
    ...
    // },
    [eVchainNetwork.vdev]: {
      VUSD: "0xbD416ABc0a02cA2f5423a55CB382B904024d85E7",
    },
    [eVchainNetwork.vchain]: {},
  },
};

export default VchainConfig;
